...
"""
This program is the main "runme" program for SpikerNet in the in vivo setup. To run SpikerNet, use anaconda to activate the 
...
Note: A good amount of setup is required to integrate with stimulation and recording equipment.
"""
if __name__ == '__main__':
    ...
    envLogDir = "./logs/INS2015_12_15_20"   #Tells the program where you want to save. .logs needs to be intialized. I like to have a date code followed by a runtime name.
    saveLog = "./models/INS2015_12_15_20"
    maxTimeSteps = 30   #Dependent on your environment. See OpenAI Gym setup for full description
    max_ep_len = 30 #How many samples do you want in each epoch? Dependent on environment
    ...
    env = VectorEnv("spiker-v0",n_envs=1)    #This tells Gym what environment to use. The name is defined in the Gym init in the config folder
